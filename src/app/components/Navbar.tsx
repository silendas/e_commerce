        ...
        <div className="flex items-center gap-3 sm:gap-5">
          {user ? (
            <>
              <div className="flex items-center gap-4 text-gray-600 mr-2">
                ...
                >
                  ...
                  {cartCount > 0 && (
                    <span className="absolute -top-1 -right-1 bg-red-500 text-white text-[10px] font-bold px-1 rounded-full min-w-[15px] text-center animate-in zoom-in">
                      {cartCount}
                    </span>
                  )}
                </Link>
            ...
            <div className="flex items-center gap-2">
              <Link
                href="/register"
                className="px-5 py-2 rounded-full text-xs font-bold text-gray-700 hover:bg-gray-100 transition uppercase tracking-widest"
              >
                Register
              </Link>
              <Link
                href="/login"
                className="bg-black text-white px-6 py-2 rounded-full text-xs font-bold hover:bg-gray-800 transition uppercase tracking-widest shadow-lg shadow-black/10"
              >
                Login
              </Link>
            </div>
